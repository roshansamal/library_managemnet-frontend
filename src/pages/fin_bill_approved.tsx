...
export default function FinBillApproved() {
    ...
    <Flex
      ...
      <Flex align="center" as="nav" aria-label="Breadcrumb" w="100%" py={1}>
        ...
        <HStack spacing={1} display={{ base: "none", md: "flex" }}>
          <Link href="/finance" color="blue.500" fontWeight="normal" fontSize={"md"}>Finance</Link>
          <Text color="gray.500">/</Text>
          <Link color="red.500" fontWeight="normal" fontSize={"md"}>Bills Approved</Link>
        </HStack>
      ...
      <Box borderWidth="1px" borderRadius="md" maxH="90vh" overflow="auto" p={0} position="relative" border={"2px solid gren"}>
...
//   useEffect(() => {
//     const params = new URLSearchParams({ ticket_status: "Finance Approved" });
...
//         body: JSON.stringify({
//           search: selectedUser,
//           ticket_status:'Finance Approved'
//         }),
//       });
//     if (!res.ok) {
//       console.error('Error:', res.status, await res.text());
