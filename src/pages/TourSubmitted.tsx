    ...
    <Box borderWidth="1px" borderRadius="md" maxH="500px" overflow="auto" p={1}>
      ...
      <HStack spacing={1} mb={5} align="flex-start" justifyContent={"left"}>
        ...
        <Button
          ...
          h={8} variant="outline" fontWeight={"thin"}
        >
          Approve Selected ({selectedIds.length})
        </Button>
        <HStack mb={0} h={8} p={0}>
          <Button colorScheme="blue" onClick={handleExportCSV} 
            px={{ base: "1", md: "2" }} py="0.5" variant="outline">
            <FaFileExcel/>
          </Button>
          <Button colorScheme="green" p={0} variant="outline">
            <FaFileCsv/>
          </Button>
          <Button colorScheme="red" p={0} variant="outline">
            <FaFilePdf/>
          </Button>
        </HStack>
      </HStack>
